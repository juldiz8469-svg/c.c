...
<body>
        ...
        <div class="container">
            <nav>
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="#skills">Технологиялар</a></li>
    ...
    <section id="home" class="hero">
        <div class="container">
            <div class="hero-content">
                <h1>Сәлем, мен Кайназарова Жулдыз Есімханқызы<span>Қазақ тілі мен әдебиеті</span> пәнінің мұғалімімін</h1>
            ...
            <div class="about-content">
                ...
                <div class="about-text">
                    ...
                    <ul class="info-list">
                        ...
                        <li><i class="fas fa-chalkboard-teacher"></i><strong>Еңбек өтілі:</strong> 7 жыл</li>
    ...
    <section id="skills" class="skills">
        <div class="container">
            <div class="section-title">
                <h2>Технологиялар мен әдіс-тәсілдер</h2>
            ...
            <div class="Әдістер">
                <div class="skill-card">
                    ...
                    <p>Қазақ тілі мен әдеббиеті пәнінде баланың деңгейіне қарай икемдеп әдіс-тәсілдерді саралаймын.</p>
                    <div class="tools-grid">
                        <div class="tool-item">Дамыта оқыту технологиясы</div>
                        <div class="tool-item">СТО дамыту технологиясы</div>
                        <div class="tool-item">Модульдік оқыту технологиясы</div>
                        <div class="tool-item">СКО технологиясы</div>
                        <div class="tool-item">Бағалау жүйесі</div>
                        <div class="tool-item">саралап оқыту</div>
                    </div>
                ...
                <div class="skill-card">
                    ...
                    <p>Сабақтарда ЖИ құралдарын кеңінен қолданамын: мәтін генерациялау, тест құрастыру, визуализация, жекелендірілген тапсырмалар әзірлеу.</p>
                    <div class="tools-grid">
                        <div class="tool-item">Мәтін генерациясы</div>
                        <div class="tool-item">Автоматты тестілеу</div>
                        <div class="tool-item">Жеке оқу жоспары</div>
                        <div class="tool-item">Визуализация</div>
                        <div class="tool-item">Бағалау жүйесі</div>
                        <div class="tool-item">Тіл үйрету</div>
                    </div>
                ...
                <div class="skill-card">
                    ...
                    <div class="tools-grid">
                        <div class="tool-item">Padlet</div>
                        <div class="tool-item">Kahoot</div>
                        <div class="tool-item">Quizizz</div>
                        <div class="tool-item">Miro</div>
                        <div class="tool-item">Jamboard</div>
                        <div class="tool-item">Canva</div>
                        <div class="tool-item">Wordwall</div>
                        <div class="tool-item">Liveworksheets</div>
                        <div class="tool-item">Nearpod</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="contact-container">
                <div class="contact-info">
                    ...
                    <div class="contact-item">
                        ...
                        <div class="contact-item-content">
                            <h4>Juldiz8469@gmail.com</h4>
                            <p>zhuldyz.kay.84@mail.ru</p>
                        </div>
                    </div>
                    <div class="contact-item">
                ...
                <div class="contact-form">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="">Электронды пошта</label>
